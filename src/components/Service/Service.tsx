	...
	return (
		<PageTransition>
			...
			<ServiceBar
				...
				changeClass={(selectedService: string) =>
			...
			{!selectedService ? (
				...
				<div className={styles.wrappercenter}>
					<div className={styles.price}>
						<div
							className={
								selectedService === "Ongles"
									? `${styles.ongles} ${styles.actif}`
									: `${styles.ongles}`
							}
						>
						...
						<div
							className={
								selectedService === "Sourcils"
									? `${styles.sourcils} ${styles.actif}`
									: `${styles.sourcils}`
							}
						>
							<h2 className={styles.subtitle}>
						...
						<div
							className={
								selectedService === "Cils"
									? `${styles.cils} ${styles.actif}`
									: `${styles.cils}`
							}
						>
							<h2 className={styles.subtitle}>
					...
					<Image
						...
						alt={""}
						classNamewrapper={styles.imgtopright}
					/>
					<Image
						src={
							selectedService === "Ongles"
						...
						alt={""}
						classNamewrapper={styles.imgbottomright}
					/>
				</div>
			)}
		</PageTransition>
